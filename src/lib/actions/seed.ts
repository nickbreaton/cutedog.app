...
export async function seedAction(form: FormData) {
  const source = [
    ...
    },
    {
      ...
      date: new Date("2023-07-01 8:19 pm"),
    ...
    },
    {
      ...
      date: new Date("2023-07-02 12:25 am"),
    ...
    },
    {
      ...
      date: new Date("2023-07-02 12:15 pm"),
      description: "",
    ...
    },
    {
      ...
      date: new Date("2023-07-01 6:48 pm"),
    ...
    },
    {
      ...
      date: new Date("2023-07-03 11:19 am"),
      description: "",
    ...
    {
      quote: ["I like your dog"],
      date: new Date("2023-07-03 11:16 am"),
  ...
  const interactions = source.map(
    (record): Omit<Interaction, "id"> => ({
      ...
      timezone: getLocalOffset(record.date),
      lat: record.coords[0],
      lon: record.coords[1],
      quotes: record.quote,
